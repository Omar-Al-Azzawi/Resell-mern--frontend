...
export default function UpdataProduct() {
    ...
    return (
        <div className='h-screen'>
            <div className='w-1/2 m-auto fixed inset-0' style={{height: '300px'}}>
                ...
                <div>
                    <button className='px-4 py-1.5 ml-2 mt-2 font-bold bg-transparint border border-gray-400 rounded-md hover:bg-blue-400 hover:text-white transition duration-300 ease-in-out' onClick={() => handleUpdata(updata._id)}>
                        Updata
                    </button>
                    <button className='px-4 py-1.5 ml-2 mt-2 font-bold bg-transparint border border-gray-400 rounded-md hover:bg-blue-400 hover:text-white transition duration-300 ease-in-out' onClick={() => navigate('/')}>
                        Back to home
                    </button>
            </div>
            </div>
